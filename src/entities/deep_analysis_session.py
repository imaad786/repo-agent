"""
Deep analysis session entity - links runs to chat sessions.
"""
...
class DeepAnalysisSession(BaseEntityMixin, table=True):
    """
    Links a deep analysis run to its chat sessions.
    ...
    """
    __tablename__ = "deep_analysis_sessions"
